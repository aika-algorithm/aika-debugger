...
public class AikaBackend implements Backend {
    ...
    @Override
    public org.graphstream.ui.swing.renderer.shape.Shape chooseNodeShape(org.graphstream.ui.swing.renderer.shape.Shape oldShape, StyleGroup group) {
    ...
    @Override
    public org.graphstream.ui.swing.renderer.shape.Shape chooseEdgeShape(org.graphstream.ui.swing.renderer.shape.Shape oldShape, StyleGroup group) {
        switch(group.getShape()) {
            case LINE:
    ...
    @Override
    public org.graphstream.ui.swing.renderer.shape.Shape chooseEdgeArrowShape(org.graphstream.ui.swing.renderer.shape.Shape oldShape, StyleGroup group) {
    ...
    @Override
    public org.graphstream.ui.swing.renderer.shape.Shape chooseSpriteShape(Shape oldShape, StyleGroup group) {
        switch (group.getShape()) {
            case CIRCLE:
                if(oldShape instanceof CircleShape)
                    return oldShape ;
